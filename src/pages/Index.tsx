              ...
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed">
                    <strong className="bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent">Our goal is to make progress as effortless as opening Instagram or using ChatGPT.</strong>
                  </p>
                </div>
              </div>
