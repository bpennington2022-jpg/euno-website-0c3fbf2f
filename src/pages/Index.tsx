...
import StatisticsBackground from "@/components/StatisticsBackground";
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-950/80 backdrop-blur-lg border-b border-gray-800/50">
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between w-full">
            <a href="/" className="text-2xl font-bold bg-gradient-to-r from-accent to-secondary bg-clip-text text-transparent">
              euno
            </a>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-8">
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent">
                    <strong>Our goal is to make progress as effortless as opening Instagram or using ChatGPT.</strong>
                  </p>
                </div>
              </div>
